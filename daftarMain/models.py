...
class OfficeUser(models.Model):
    ...
    code_bime = models.CharField(max_length=30,null=True,blank=True)
    family_phone_number = models.CharField(max_length=15,null=True,blank=True)
    marital_status = models.BooleanField(default=False)
    military_service_status = models.CharField(max_length=3 ,choices= MILITARY_SERVICE_TYPE, default='N/A')
    childeren_count = models.CharField(max_length=3,default= 0)
...
class Clock(models.Model):
    entry_to_office = jmodels.jDateTimeField(null=True, blank=True)
    exit_from_office = jmodels.jDateTimeField(null=True, blank=True)
